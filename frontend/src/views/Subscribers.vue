...
<template>
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            <div class="p-4 bg-white border border-gray-200 rounded-lg" v-if="subscribers.length">
                <h2 class="mb-6 text-xl">Мои подписчики</h2>

                <div class="p-4 text-center bg-gray-100 rounded-lg mb-2" v-for="subscriber in subscribers"
                    :key="subscriber.id">
