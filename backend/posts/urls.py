...
from .api import PostDetailView, PostListProfileView, PostListView, toggle_like,post_create_comment

urlpatterns = [
    path("", PostListView.as_view(), name="post-list"),
    path("detail/<uuid:pk>/", PostDetailView.as_view(), name="post-detail"),
    path("detail/<uuid:pk>/comment/create/", post_create_comment, name="post-create-comment"),
